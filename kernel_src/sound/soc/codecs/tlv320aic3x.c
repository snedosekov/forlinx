...
static int aic3x_init(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, DACR1_2_RLOPM_VOL, ROUTE_ON);
	...
	snd_soc_write(codec, LADC_VOL, 0x06);
	snd_soc_write(codec, RADC_VOL, 0x06);
	...
	snd_soc_write(codec, LINE2L_2_MONOLOPM_VOL, ROUTE_ON);
	snd_soc_write(codec, LINE2R_2_MONOLOPM_VOL, ROUTE_ON);
...
static int aic3x_probe(struct snd_soc_codec *codec)
{
	...
	snd_soc_write(codec, MICBIAS_CTRL, 0xc0);
